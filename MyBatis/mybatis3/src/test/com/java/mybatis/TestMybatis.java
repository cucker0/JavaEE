...
import com.java.dao.EmployeeMapperAnnotation;
...
public class TestMybatis {
    ...
    public void testSelectEmployee() {
        ...
        try {
            ...
            // sqlSession不是线程安全，因此每次连接数据库时，都需要重新获取和关闭。如果使用了连接池方式，关闭时释放资源到连接池
    ...
    @Test
    public void testSelectEmployee2() {
        // 获取sqlSession对象
        SqlSession sqlSession = getSqlSessionFactory().openSession();
        try {
            EmployeeMapper mapper = sqlSession.getMapper(EmployeeMapper.class);
            System.out.println("mapper: " + mapper);  // mapper: org.apache.ibatis.binding.MapperProxy@92256
            Employee employee = mapper.getEmployeeById(21L);
            System.out.println(employee);
        } finally {
            sqlSession.close();
        }
