...
public class TestMP {
    ...
    // insertAllColumn 插入所以列，注意新版本已经废弃了
    @Test
    public void testInsertAllColumn() {
        Employee e = new Employee();
        e.setLastName("张茜");
        e.setEmail("zhangq@163.com");
        Integer lines = employeeMapper.insertAllColumn(e);
        /*
        * insertAllColumn(T)，管理插入的属性是否为空，插入全部字段
        *
        * 2020-12-07 16:37:00.195 [main] DEBUG com.java.mp.mapper.EmployeeMapper.insertAllColumn - ==>
        *   Preparing: INSERT INTO tbl_employee ( last_name,email,gender,age ) VALUES ( ?,?,?,? )
        * 2020-12-07 16:37:00.240 [main] DEBUG com.java.mp.mapper.EmployeeMapper.insertAllColumn - ==>
        *   Parameters: 张茜(String), zhangq@163.com(String), null, null
        * */
        System.out.println(lines);
